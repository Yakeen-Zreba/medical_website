        ...
        <div class="admin-content">
           ...
           <div class="buttom-gruop">
            ...
            <div class="other-content">
              ...
              <form action="edit_topics.php" method="POST" name="topic" id="topic" enctype="multipart/form-data" onsubmit="return t_check(this)">
                ...
                <div>
                    <button type="submit" name="editTopic" class="btn2 btn-big"><i class="fas fa-save"></i>&nbsp;&nbsp;&nbsp;Save</button>
                </div>
              </form>
            </div>
