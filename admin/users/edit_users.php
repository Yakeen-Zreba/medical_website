    ...
    <section id="Admin-wrapper">
        ...
        <div class="admin-content">
            <div class="buttom-gruop">
                ...
                <a href="index_users.php" class="btn btn-big">Manage Admin</a>
            ...
            <form action="edit_users.php" method="POST" id="user" name="user"  onsubmit="return u_check(this)">
            <input type="hidden" name="id" value="<?php echo $id; ?>" required>
             ...
             <p id="demo"></p>
                ...
                <div>
                <button type="submit" name="editAdmin" class="btn2 btn-big" style="margin-top:20px;"><i class="fas fa-save"></i>&nbsp;&nbsp;&nbsp;Save</button>
                </div>
