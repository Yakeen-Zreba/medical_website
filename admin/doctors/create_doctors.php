...
<html>
    ...
    <head>
        <meta charset="UTF_8">
        <title>Admin Section / Add Doctors</title>
    ...
    <section id="Admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <form action="create_doctors.php" method="POST" id="doctor" name="doctor" enctype="multipart/form-data"  onsubmit="return d_check(this)">
                <div>
               ...
               <div>
                ...
                <div>
                    <label >Phone</label>
                    <input type="text" name="doctorphone" id="doctorphone" class="admin-input" maxlength="11" onkeypress="return onlyNumberKey(event)" placeholder="Accept only numbers.." value="<?php echo $phone; ?>">
                </div>
                <div>
             ...
             <p id="demo"></p>
                ...
                <div>
                <button type="submit" name="adddoctor" class="btn2 btn-big"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Add</button>
                </div>
