...
<html>
    ...
    <head>
        <meta charset="UTF_8">
        <title>Admin Section / Manage Doctors</title>
                ...
                <?php foreach($doctors as $key => $doctor):?>
                    <tbody>
                      <tr>
                          ...
                          <td><?php echo  $doctor['doctoremail']?></td>
                          <td><?php echo  $doctor['specialty']?></td>
                          <td><a href="edit_doctors.php?id=<?php echo $doctor['id']; ?>" class="edit"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;edit</a></td>
                          <td><a href="index_doctors.php?deleteID=<?php echo $doctor['id']; ?>" class="delete"><i class="fas fa-user-times"></i>&nbsp;&nbsp;delete</a></td>
                      </tr>
                  </tbody>
                <?php endforeach; ?>  
