...
<html>
    ...
    <head>
        <meta charset="UTF_8">
        <title>Admin Section / Edit Articles</title>
    ...
    <section id="Admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="other-content">
              ...
              <form action="edit_articles.php" method="POST" name="article" id="article" enctype="multipart/form-data" onsubmit="return a_check(this)">
              <input type="hidden" name="id" value="<?php echo $id; ?>" >

                <div>  
                    <label>Title</label>
                    <input type="text" name="title" class="admin-input" value="<?php echo $title; ?>" >
                </div>
                <div>  
                    <label>Text content</label>
                    <textarea name="textContent" class="admin-input" id="textContent"><?php echo $textContent; ?></textarea>
                </div>
                ...
                <div>
                    <button type="submit" name="editArticle" class="btn2 btn-big"><i class="fas fa-save"></i>&nbsp;&nbsp;&nbsp;Save</button>
                </div>
